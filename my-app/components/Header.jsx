...
export default function Header() {
  ...
  const navItemClass =
    "text-sm font-medium text-gray-700 hover:text-indigo-600 transition-colors px-3 py-2 rounded-md";
  const mobileLinkClass =
    "flex items-center gap-3 p-3 text-base text-gray-700 hover:bg-indigo-50 hover:text-indigo-700 rounded-lg transition-all ease-in-out";
  const primaryButtonClass =
    "bg-indigo-600 text-white font-medium text-sm px-4 py-2 rounded-lg shadow-md hover:bg-indigo-700 transition duration-150 ease-in-out focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2";
  const secondaryButtonClass =
    "text-indigo-600 font-medium text-sm px-4 py-2 rounded-lg hover:bg-indigo-50 transition duration-150 ease-in-out";
        ...
        <nav className="hidden md:flex items-center space-x-2">
          {loading ? (
            ...
            <div className="flex items-center space-x-4">
              {dashboardText && (
                <Link href={dashboardLink} className={navItemClass}>
                  {dashboardText}
                </Link>
              )}
            ...
            {loading ? (
              ...
              <>
                <Link
                  ...
                  className={secondaryButtonClass.replace(
                    "px-4 py-2",
